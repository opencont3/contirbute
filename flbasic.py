...
Original file is located at
    https://colab.research.google.com/drive/1pEbRwH7hs4hpddD96HCadghYw8WQcAA3
"""
...
f.close()
f1= open("FLbasicMNISTGlobal.txt", "a+") 
f1.close()
epoch=np.random.randint(2,6,40)
print(epoch)
...
for comm_round in range(200):
  ...
  for ind in range(40):
    ...
    scaling_factor=1.0/40 #1/no.ofclients
